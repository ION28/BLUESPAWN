...
int main()
{
	...
	cout << "DNS FQDN: " << GetFQDN() << endl;
	cout << "Computer DNS Name: " << GetComputerDNSName() << endl;
	cout << "Active Directory Domain: " << GetDomain() << endl;
	cout << "Operating System: " << GetOsVersion() << endl;
	cout << "Current User: " << GetCurrentUser() << endl;
}
